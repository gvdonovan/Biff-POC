...
(function () {
    ...
    function routerHelperProvider($locationProvider, $stateProvider, $urlRouterProvider) {
        ...
        RouterHelper.$inject = ['$location', '$rootScope', '$state', 'logger', 'modalService', 'spaConfig'];
        /* @ngInject */
        function RouterHelper($location, $rootScope, $state, logger, modalService, spaConfig) {
